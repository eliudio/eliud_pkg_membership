...
typedef MembershipDashboardChanged(String? value);
...
class MembershipDashboardDropdownButtonWidget extends StatefulWidget {
  ...
  MembershipDashboardDropdownButtonWidget({ required this.app, this.value, this.trigger, this.optional, Key? key }): super(key: key);
