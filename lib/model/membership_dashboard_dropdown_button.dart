...
typedef MembershipDashboardChanged(String? value, int? privilegeLevel,);
...
class MembershipDashboardDropdownButtonWidget extends StatefulWidget {
  ...
  MembershipDashboardDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return MembershipDashboardDropdownButtonWidgetState();
  }
}

class MembershipDashboardDropdownButtonWidgetState extends State<MembershipDashboardDropdownButtonWidget> {
  MembershipDashboardListBloc? bloc;

  MembershipDashboardDropdownButtonWidgetState();
...
List<Widget> widgets(MembershipDashboardModel value) {
var app = widget.app;
var widgets = <Widget>[];
...
return widgets;
        ...
        return ListView(
          ...
          Row(children: [(false)
            ? Container(
                ...
                child: dropdownButton<String>(
                      ...
                      items: items,
                      value: widget.value,
                      hint: text(widget.app, context, 'Select a membershipDashboard'),
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'membershipDashboards', widget.value, (newValue, _) {
                  setState(() {
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<MembershipDashboardListBloc>(context).add(MembershipDashboardChangeQuery(
