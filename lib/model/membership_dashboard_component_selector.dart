...
class _SelectMembershipDashboardWidgetState extends State<SelectMembershipDashboardWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<MembershipDashboardListBloc>(context).add(
            MembershipDashboardChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID)));
    }
  }
