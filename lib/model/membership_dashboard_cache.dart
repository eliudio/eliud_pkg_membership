...
class MembershipDashboardCache implements MembershipDashboardRepository {
  ...
  Future<MembershipDashboardModel> get(String id, {Function(Exception) onError}) {
    MembershipDashboardModel value = fullCache[id];
  ...
  @override
  StreamSubscription<List<MembershipDashboardModel>> listen(trigger, {String currentMember, String orderBy, bool descending, Object startAfter, int limit, int privilegeLevel, EliudQuery eliudQuery}) {
  ...
  @override
  StreamSubscription<List<MembershipDashboardModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, Object startAfter, int limit, int privilegeLevel, EliudQuery eliudQuery}) {
  ...
  @override
  StreamSubscription<MembershipDashboardModel> listenTo(String documentId, changed) {
