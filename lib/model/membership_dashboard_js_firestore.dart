...
class MembershipDashboardJsFirestore implements MembershipDashboardRepository {
  Future<MembershipDashboardModel> add(MembershipDashboardModel value) {
    return membershipDashboardCollection.doc(value.documentID)
  ...
  @override
  StreamSubscription<List<MembershipDashboardModel>> listen(MembershipDashboardModelTrigger trigger, {String currentMember, String orderBy, bool descending, Object startAfter, int limit, SetLastDoc setLastDoc, int privilegeLevel, EliudQuery eliudQuery }) {
    var stream;
  ...
  StreamSubscription<List<MembershipDashboardModel>> listenWithDetails(MembershipDashboardModelTrigger trigger, {String currentMember, String orderBy, bool descending, Object startAfter, int limit, SetLastDoc setLastDoc, int privilegeLevel, EliudQuery eliudQuery }) {
    var stream;
    // If we use membershipDashboardCollection here, then the second subscription fails
    stream = getQuery(getCollection(), currentMember: currentMember, orderBy: orderBy,  descending: descending,  startAfter: startAfter,  limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId).onSnapshot
        .asyncMap((data) async {
  ...
  Stream<List<MembershipDashboardModel>> values({String currentMember, String orderBy, bool descending, Object startAfter, int limit, SetLastDoc setLastDoc, int privilegeLevel, EliudQuery eliudQuery }) {
    ...
    Stream<List<MembershipDashboardModel>> _values = getQuery(membershipDashboardCollection, currentMember: currentMember, orderBy: orderBy,  descending: descending,  startAfter: startAfter,  limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId)
      .onSnapshot
      .map((data) { 
  ...
  Future<List<MembershipDashboardModel>> valuesList({String currentMember, String orderBy, bool descending, Object startAfter, int limit, SetLastDoc setLastDoc, int privilegeLevel, EliudQuery eliudQuery }) async {
    DocumentSnapshot lastDoc;
    List<MembershipDashboardModel> _values = await getQuery(membershipDashboardCollection, currentMember: currentMember, orderBy: orderBy,  descending: descending,  startAfter: startAfter,  limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId).get().then((value) {
      var list = value.docs;
      return list.map((doc) { 
        lastDoc = doc;
        return _populateDoc(doc);
  ...
  Future<void> deleteAll() {
    return membershipDashboardCollection.get().then((snapshot) => snapshot.docs
        .forEach((element) => membershipDashboardCollection.doc(element.id).delete()));
  }
  ...
  final String appId;
  MembershipDashboardJsFirestore(this.membershipDashboardCollection, this.appId);
  ...
  // CollectionReference getCollection() => membershipDashboardCollection;
  CollectionReference getCollection() => appRepository().getSubCollection(appId, 'membershipdashboard');
